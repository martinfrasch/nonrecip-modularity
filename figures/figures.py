...
def baseline():
    ts = pd.read_csv("results/timeseries.csv")
    ...
    plt.tight_layout()
    plt.savefig("figures/modularity_test.png", dpi=160)
...
def chi_figure():
    ...
    plt.tight_layout()
    plt.savefig("figures/chi_test.png", dpi=160)
...
def coarsening():
    ...
    plt.tight_layout(); plt.savefig("figures/coarsening.png", dpi=160)
